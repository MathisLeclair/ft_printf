...
/*   Updated: 2016/12/08 19:05:36 by mleclair         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_opts2(char *tab, char *opt, char **str, int i)
{
	...
	if (tab[0] == 1 && opt[ft_strlen(opt) - 1] != 'c' && ((*str)[0] != '0'
		|| (*str)[1] != 0 || (opt[ft_strlen(opt) - 1] != 'x' && opt[ft_strlen(opt) - 1] != 'X')) && (i != 0 || opt[ft_strlen(opt) - 1] != 'x'))
	{
	...
	if (tab[4])
		i = ft_number(i, ft_atoi_base_printf(opt, 10, 0), ((tab[5] == 0 || !ft_fuckit(opt[ft_strlen(opt) - 1])) ? tab[3] : 0), str);
	if (tab[2])
		ft_minus(i, 0, (opt[ft_strlen(opt) - 1] == 'o' || opt[ft_strlen(opt) - 1] == 'O') ? 1 : tab[5] - 1, str);
	if (tab[6])
